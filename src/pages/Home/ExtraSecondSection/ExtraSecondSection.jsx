                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <div className="flex justify-center items-center mb-4">
                            ...
                            <img className="h-96 w-96 rounded-xl" src="https://www.junglegym.co.uk/media/catalog/product/cache/bc515597db4cec1910a18b2933eb9727/k/i/kids_playground_q3_hy-land.jpg" alt="" />
                        </div>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        <div className="flex justify-center items-center mb-4">
                            ...
                            <img className="h-96 w-96 rounded-xl" src="https://previews.123rf.com/images/yotrak/yotrak1207/yotrak120700160/14484797-modern-children-playground-in-park.jpg" alt="" />
                        </div>
